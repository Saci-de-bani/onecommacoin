...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("OneCommaCoin Core onecommacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  onecommacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded onecommacoin transaction") + "\n" +
                               "  onecommacoin-tx [options] -create [commands]   " + _("Create hex-encoded onecommacoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded onecommacoin transaction
