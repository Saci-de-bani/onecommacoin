                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("OneCommaCoin-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OneCommaCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and onecommacoin: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About OneCommaCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about OneCommaCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for OneCommaCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OneCommaCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OneCommaCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a OneCommaCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the OneCommaCoin Core help message to get a list with possible OneCommaCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("OneCommaCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OneCommaCoin network", "", count));
}
...
{
    QString strTitle = tr("OneCommaCoin Core"); // default title
