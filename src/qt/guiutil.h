...
/** Utility functions used by the OCC Qt UI.
 */
namespace GUIUtil
{
...
// Render OCC addresses in monospace font
...
// Parse "onecommacoin:" URI into recipient object, return true on successful parsing
