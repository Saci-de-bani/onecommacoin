...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("OneCommaCoin Core"),
     ...
     * override -datadir in the onecommacoin.conf file in the default data directory
     * (to be consistent with onecommacoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
