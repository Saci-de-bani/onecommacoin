...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop OneCommaCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "OneCommaCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OCC features */
        {"onecommacoin", "masternode", &masternode, true, true, false},
        {"onecommacoin", "masternodelist", &masternodelist, true, true, false},
        {"onecommacoin", "mnbudget", &mnbudget, true, true, false},
        {"onecommacoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"onecommacoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"onecommacoin", "mnsync", &mnsync, true, true, false},
        {"onecommacoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"onecommacoin", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use onecommacoind, or the -server option to onecommacoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"OneCommaCoin Alert\" admin@foo.com\n"),
...
{
    return "> onecommacoin-cli " + methodname + " " + args + "\n";
}
