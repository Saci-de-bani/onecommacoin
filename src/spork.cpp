...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_2_INSOCCTX) r = SPORK_2_INSOCCTX_DEFAULT;
        if (nSporkID == SPORK_3_INSOCCTX_BLOCK_FILTERING) r = SPORK_3_INSOCCTX_BLOCK_FILTERING_DEFAULT;
...
{
    if (strName == "SPORK_2_INSOCCTX") return SPORK_2_INSOCCTX;
    if (strName == "SPORK_3_INSOCCTX_BLOCK_FILTERING") return SPORK_3_INSOCCTX_BLOCK_FILTERING;
...
{
    if (id == SPORK_2_INSOCCTX) return "SPORK_2_INSOCCTX";
    if (id == SPORK_3_INSOCCTX_BLOCK_FILTERING) return "SPORK_3_INSOCCTX_BLOCK_FILTERING";
