/* src/config/onecommacoin-config.h.  Generated from onecommacoin-config.h.in by configure.  */
/* src/config/onecommacoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://onecommacoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "OneCommaCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "OneCommaCoin Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "onecommacoin"
