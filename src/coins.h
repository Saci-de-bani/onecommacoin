...
/** 
    ...
    ****Note - for OCC we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
static const unsigned int SOCCDARD_LOCKTIME_VERIFY_FLAGS = LOCKTIME_VERIFY_SEQUENCE |
...
public:
    ...
    /** 
     * Amount of onecommacoin coming in to a transaction
