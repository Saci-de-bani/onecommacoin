...
In order to support loading of multiple wallets in onecommacoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is onecommacoin.cpp.
...
Changes to onecommacoin.cpp
----------------------
onecommacoin.cpp is the entry point into onecommacoin-qt, and as such, will require some minor modifications to provide hooks for
