...
This mechanism has been integrated into Bitcore-Node-OneCommaCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/onecommacoin-crypto/insight-api-onecommacoin#web-socket-api](https://github.com/onecommacoin-crypto/insight-api-onecommacoin#web-socket-api) 
* API: [https://github.com/onecommacoin-crypto/insight-api-onecommacoin#swifttx-transactions](https://github.com/onecommacoin-crypto/insight-api-onecommacoin#swifttx-transactions) 
...
By default, the OneCommaCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the OneCommaCoin Core daemon:
